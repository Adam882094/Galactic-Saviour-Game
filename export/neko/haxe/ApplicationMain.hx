...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Galactic_Saviour", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Galactic_Saviour", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Galactic_Saviour";
		app.meta["name"] = "Galactic_Saviour";
